...
import main.resource.lang.langage.EN;
import main.resource.lang.typetrad.ColorName;
import main.resource.lang.typetrad.MenuName;
...
public class NewUI2Controller implements Initializable {
  ...
  private void loadFxml(int nbServ) {
    try {
      ...
      FXMLLoader loader = new FXMLLoader(
              getClass().getResource("../../resource/gui/IRC.fxml"
              )
      );
  ...
  private Lang getLang(String language) {
    try {
      Class<?> clazz = Class.forName("main.resource.lang.langage." + language.toUpperCase());
  ...
  private void addServ() {
    ...
    Image logo = new Image("main/resource/image/logov4.png");
    iw.setImage(logo);
